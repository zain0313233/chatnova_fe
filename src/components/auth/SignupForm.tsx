    ...
    const initGoogleSignIn = () => {
      if (typeof window !== 'undefined' && (window as any).google) {
        ...
        if (googleButtonRef.current) {
          ...
          style.textContent = `
            #${googleButtonRef.current.id || 'google-signup-button'} div,
            #${googleButtonRef.current.id || 'google-signup-button'} iframe {
      ...
      <div className="w-full max-w-md py-4">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm text-gray-600 sm:text-base">
            Create your account to start monitoring AI chat performance and
            optimize your conversation operations.
          </p>
        </div>
